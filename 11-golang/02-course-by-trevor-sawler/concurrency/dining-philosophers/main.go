...
var orderMutex sync.Mutex  // a mutex or the slice orderFinished
var orderFinished []string // the order in which philophers finish dining and leave
...
func diningProblem(philosopher Philosopher, wg *sync.WaitGroup, forks map[int]*sync.Mutex, seated *sync.WaitGroup) {
	...
	// seat the philopher at the table
